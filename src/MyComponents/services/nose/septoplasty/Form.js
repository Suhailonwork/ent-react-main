          ...
          <div className="row">
              <div className="col-xl-7 px-xl-8 mt-4 mt-xl-0">
                <div className="pq-section pq-style-1 text-left">
                 ...
                 Septoplasty is a surgical procedure to correct a deviated nasal septum, which occurs when the thin wall of cartilage and bone (the septum) that divides the nasal cavity is off-centre or crooked. A deviated septum can lead to breathing difficulties, nasal congestion, snoring, recurrent sinus infections, and sometimes nosebleeds or facial pressure.
The goal of septoplasty is to straighten the septum to improve airflow through the nasal passages. The procedure is performed under local or general anaesthesia and typically takes 30 to 60 minutes. During the surgery, the surgeon removes or repositions the deviated parts of the septum through the nostrils—without any external scars.
